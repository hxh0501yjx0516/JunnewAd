...
/**
 * 
 * Title: �ļ��ϴ��� Description: ���ܶ��ļ������ϴ�,����ȡ��������ֵ,����ͬʱ�ϴ�255���ļ� Copyright:
 * 
 * @author 
 * 
 */
...
public class UploadBean {
	...
	private String canSuffix = ".gif.jpg.jpeg.png.xls.xlsx"; // ���ϴ����ļ���׺��
	private String objectPath = "E:/tomcat60/webapps/ad/upload/"; // Ŀ���ļ�Ŀ¼
