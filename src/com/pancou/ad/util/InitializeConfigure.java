...
@Entity
public class InitializeConfigure extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public InitializeConfigure() {
		super();
	}
	...
	public void init() throws ServletException {
        ...
        TimerTask   task   =   new   TimerTask()   { 
			...
			public   void   run()   { 
            	...
            	List<Users> list = dao.findAll(Users.class);
...
//        System.out.println(start.toLocaleString()); 
        //ʱ����һ�� 
        String hours = "24";
        long   period= Integer.parseInt(hours)*60*60*1000;
