...
(function($) {
	if ($.validator) {
		$.validator.addMethod("alphanumeric", function(value, element) {
			return this.optional(element) || /^(?=^.{6,20}$)(?=(?:.*?\d))(?=.*[a-z])(?=(?:.*?[~,<>!@#$%*()_+^&}{:;?.]))(?!.*\s)[0-9a-zA-Z~,<>!@#$%*()_+^&}{:;?.]*$/.test(value);
...
var options={
	...
	if ($.fn.ajaxTodo)
		$("a[target=navTabTodo]", $p).ajaxTodo($p);
	if ($.fn.ajaxTodo)
	...
	$("a[target=ajax]", $p).each(function() {
		$(this).click(function(event) {
			...
			if (rel) {
				...
				$rel.loadUrl(encodeURI(encodeURI($this.attr("href"))), {}, function() {
	...
	if (json.statusCode == DWZ.statusCode.ok) {
		...
		if ("closeCurrent" == json.callbackType) {
			setTimeout(function() {
				...
				//跳转回父标签
				//添加
				if(navTab._indexTabId(json.navTabId)>0){
				navTab._switchTab(navTab._indexTabId(json.navTabId));
				}
			}, 100);
			...
			$this.click(function(event) {
				...
				if (title) {
					alertMsg.confirm(title, {
						...
						//添加
						if($this.attr("rel")){
							ajaxTodo(url+"&rel="+$this.attr("rel"), $this.attr("callback"));
						}else{
...
var setting={
				...
				pagerForm : function(options) {
					...
					return this.each(function() {
						...
						var actionUrl = $pagerForm.attr("action").replaceAll(
								"#rel#", $searchForm.attr("action"));
					...
					return this
							.each(function() {
								...
								var itemDetail = $table.attr("itemDetail")
										|| "", fields = [];
								$table
										.find("tr:first th[type]").each(function(){
var $th=$(this);
var field={
														type : $th.attr("type")
																|| "text",
					...
					function tdHtml(field, itemDetail) {
						...
						case 'lookup':
							...
							html = '<input type="hidden" name="'
									...
									+ '" lookupName="'
									+ field.lookupName
									+ '" index="#index#" title="鏌ユ壘甯﹀洖">鏌ユ壘甯﹀洖</a>';
							break;
						case 'lookupField':
							html = '<input type="text" name="'
									+ lookupFieldName + '" size="' + field.size
						...
						case 'attach':
							html = '<input type="hidden" name="'
									...
									+ '" lookupName="'
									+ field.lookupName
									+ '" index="#index#" width="560" height="300" title="鏌ユ壘甯﹀洖">鏌ユ壘甯﹀洖</a>';
							break;
						case 'enum':
							$.ajax( {
								type : "POST",
