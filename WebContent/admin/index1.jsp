...
$(function(){
  ...
  <body>
   	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<a href="#" style=" font-size:28px; line-height:50px; font-weight:bold; color:white">北京中润无线广告有限公司</a>
				<ul class="nav">
				...
				<div class="navTab-panel tabsPageContent">
					<div>
						<div class="accountInfo">
							...
							<p><span>北京中润无线广告有限公司</span></p>
							<p>登录名：${user.username }</p>
						</div>
						
						<div class="pageFormContent" layoutH="80" style="margin-right:0">

	<c:if test="${roleId eq 10 || roleId eq 20 || roleId eq 13}">
	
	<h1 style="font-size: 18px; margin-left:5px;">财务结算信息</h1>
    <pre style="margin:5px; font-size:14px; line-height:22px">
    
    <a href="#"><font style="font-size: 14px; font-weight:bold; text-decoration: underline"><${flag0 }条> 新增数据已核对，待审核</font></a>
    <${flag1 }条> 数据已审核完成，待支付
    <font style="font-size: 14px; color:blue"><${flag2 }条> 数据支付成功</font>
    <font style="font-size: 14px; color:red"><${flag3 }条> 数据未付成功</font>
