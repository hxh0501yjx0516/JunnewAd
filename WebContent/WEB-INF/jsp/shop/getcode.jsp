...
<body>
	...
	<div class="pageContent">
		<form name="codeForm" method="post"  class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
			<div class="pageFormContent" layoutH="33">
				<p>
					<div style="display:block; height:50px;width: 400px;">
					<textarea id="codeContent" cols="60" rows="6">${codeAddress}</textarea>
